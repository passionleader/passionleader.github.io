...
* Commit
  ...
  * 다음 형식을 권장한다 <br> ![img_92](https://user-images.githubusercontent.com/104918800/175814872-11381948-0b96-4699-bb49-aadc0f568598.png)

<br>
<hr>

## 2. GIT 실습 - 초기설정
1. Git을 설치한다 (기본 설정으로) <br>
2. C 드라이브에 폴더 생성
   * ![img_139](https://user-images.githubusercontent.com/104918800/175814869-03277368-8d0a-487a-85d0-146fce70147b.png)  <br>
3. 우클릭, git bash here <br>
4. 리눅스의 bash shell이 뜰 것임 (깃을 설치하며 깃에 해당 셸이 설치됨)
   * ![img_93](https://user-images.githubusercontent.com/104918800/175814873-243190d4-5244-48b1-ab32-755f6e6d07a8.png)  <br>
5. 초기 설정
...
1. git init
   ...
   * 위 명령어로 만들어진 .git 폴더가 있으면 로컬 저장소가 됨! <br>
...
3. git status
   ...
   * ![img_95](https://user-images.githubusercontent.com/104918800/175814876-e1111957-b4df-42d7-aa6d-bece858fc095.png)  <br>

4. git commit
   * 커밋을 함, 어떤 작업을 했는지 적는다
   * git commit -m "created new file"
   * 작업내용의 경우, 회사같은 곳에서는 add, create등 단어를 지정해 주기도 함 <br>

5. git log
   * git log 입력해 보면 commit 한 이력이 나온다
   * 커밋 이력을 확인해 볼 수 있다
   * ![img_96](https://user-images.githubusercontent.com/104918800/175814877-ea43e11c-14e4-4436-911c-16a0186fc64e.png) <br>
...
6. 연습: 이제 파일을 수정해 보자
   ...
   * ![img_99](https://user-images.githubusercontent.com/104918800/175814880-d610e759-3b62-410d-be3e-22c7161a2219.png) <br>
...
1. 깃에 깃허브 연동하기
  ...
  * 원격 저장소(원본) 이름을 지정후 연동한다 (이름을 origin이라고 지정할 경우)
    * git remote add origin https://github.com/passionleader/tutorial.git  <br>
...
3. 연결된 곳 확인해 보기
  * git remote -v
  * ![img_103](https://user-images.githubusercontent.com/104918800/175814882-1b9d0077-13eb-49b9-a9d7-ebe9e20d4f65.png) <br>
...
* PC2 (그냥 연습용으로 다른 폴더여도 됨)
  ...
  * 받아온 파일 수정: test.txt
  * git status - git add - git commit - git push <br>
